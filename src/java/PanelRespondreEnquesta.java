...
public class PanelRespondreEnquesta extends JPanel {
    ...
    public PanelRespondreEnquesta(CtrlPresentacio ctrl, String surveyTitle) {
        this.ctrl = ctrl;
        this.questionsData = ctrl.getCurrentSurveyQuestionsData();
        ...
        btnRespondre.addActionListener(e -> {
            ...
            ctrl.tractarEnviarResposta(sb.toString());
        });
        ...
        if ("Opció Única Ordenada".equals(tipus) || "Opció Única Desordenada".equals(tipus)) {
            ...
            if (c instanceof JTextField) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Introduïu un número vàlid.");
                    return false;
                }
            }
        }
