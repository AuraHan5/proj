...
public class PanelCrearEnquesta extends JPanel {
    ...
    public PanelCrearEnquesta(CtrlPresentacio ctrl) {
    ...
    public void actionPerformed_btnOk(ActionEvent e) {
        ...
        if (!t.isEmpty() && t.length() < 100) {
            ...
            JOptionPane.showMessageDialog(this, "És obligatori posar títol.");
        }
    }
