...
public class CtrlPresentacio {
    ...
    public void anarARespondreEnquesta(){
        ...
        if (llista.isEmpty()) {
            JOptionPane.showMessageDialog(null, "No hi ha enquestes disponibles per respondre.");
            return;
        }
        PanelSeleccionarEnquesta panelSel = new PanelSeleccionarEnquesta(this, "RESPONDRE");
    ...
    public void anarAnalisis(){
        List<String> llista = getSurveyTitles();
        if (llista.isEmpty()) {
            JOptionPane.showMessageDialog(null, "No hi ha enquestes disponibles per analitzar.");
            return;
        }
        PanelSeleccionarEnquesta panelSel = new PanelSeleccionarEnquesta(this, "ANALISIS");
        vistaPrincipal.mostrarVistaDinamica(panelSel, "SELECCIONAR_ENQUESTA_ANALISIS");
    }

    public void anarAnalisisRespostes(){
        PanelAnalisis panel = new PanelAnalisis(this, null, false);
    ...
    public void anarAModificarEnquesta() {
        ...
        if (llista.isEmpty()) {
            JOptionPane.showMessageDialog(null, "No hi ha enquestes disponibles per modificar.");
            return;
        }

        PanelSeleccionarEnquesta panelSel = new PanelSeleccionarEnquesta(this);
    ...
    public void anarAEliminarEnquesta(){
        ...
        if (llista.isEmpty()) {
            JOptionPane.showMessageDialog(null, "No hi ha enquestes disponibles per eliminar.");
            return;
        }

        PanelEsborrarEnquesta panelDel = new PanelEsborrarEnquesta(this);
    ...
    public void anarACrearPregunta(){
        PanelEditorPregunta panelUnificat = new PanelEditorPregunta(
            this, 
            "", 
    ...
    public void navegarPregunta(String indexDesti) {
        ...
        PanelEditorPregunta panel = new PanelEditorPregunta(
            this,
            enunciat,
            tipus,
            parts[2],
    ...
    public void guardarModificacioPreguntaOpcions(String indexStr, String enunciat, String tipus, String opcionsSerialized, int maxRespostes) {
        ...
        // B. CAS MODIFICACIÓ (Editar existent)
            ...
            JOptionPane.showMessageDialog(null, "Canvis guardats correctament a la pregunta " + (index + 1));
        }
    }
    ...
    public void tractarAfegirPregunta(String enunciat, String tipus, String opcionsSerialized, int maxRespostes) {
        ...
        JOptionPane.showMessageDialog(null, "Nova pregunta creada correctament!");
    }
    ...
    public void tractarSeleccioEnquestaPerRespond(String surveyTitle) {
        ...
        PanelRespondreEnquesta panel = new PanelRespondreEnquesta(this, surveyTitle);
    ...
    public void tractarSeleccioEnquestaPerAnalisis(String surveyTitle) {
        ctrlDomini.setCurrentSurveyByTitle(surveyTitle);
        PanelAnalisis panel = new PanelAnalisis(this, surveyTitle);
    ...
    public void tractarSeleccioEnquestaPerAnalisisRespostes(String surveyTitle) {
        ctrlDomini.setCurrentSurveyByTitle(surveyTitle);
        PanelAnalisis panel = new PanelAnalisis(this, surveyTitle, false);
        vistaPrincipal.mostrarVistaDinamica(panel, "ANALISIS_RESPOS_ENQUESTA");
    }
    ...
    public String tractarFerAnalisiRespostes(String filePath, String kStr) throws IOException {
        return ctrlDomini.tractarFerAnalisiRespostes(filePath, kStr);
    }
    ...
    public void tractarEnviarResposta(String serialized) {
        ...
        JOptionPane.showMessageDialog(null, "Gràcies per respondre l'enquesta!");
        anarAMenu();
    }

    public void tractarEliminarEnquesta(String title) {
        ctrlDomini.eliminarEnquesta(title);
        JOptionPane.showMessageDialog(null, "Enquesta esborrada correctament.");
        anarAGestionarEnquesta();
    }
    ...
    public void eliminarPregunta(String indexStr) {
        ...
        if (index < 0 || index >= totalBefore) {
            JOptionPane.showMessageDialog(null, "Índex de pregunta invàlid.");
            return;
        }
        ...
        if (totalAfter == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Pregunta eliminada. S'ha creat una pregunta per defecte.");
            navegarPregunta("0");
            return;
        }
        ...
        JOptionPane.showMessageDialog(null, "Pregunta eliminada correctament.");
