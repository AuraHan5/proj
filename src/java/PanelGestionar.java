...
public class PanelGestionar extends JPanel {
    ...
    public PanelGestionar(CtrlPresentacio ctrl) {
    ...
    public void actionPerformed_btnImport(ActionEvent e) {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            // Ask for title
            String title = JOptionPane.showInputDialog(this, "Introdueix el títol de l'enquesta:");
            if (title == null || title.trim().isEmpty()) return;
            
            // Ask for description
            String description = JOptionPane.showInputDialog(this, "Introdueix la descripció de l'enquesta:");
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Error en importar l'enquesta: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
