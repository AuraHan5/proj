...
public class VistaPrincipal extends JFrame {
    ...
    private void inicialitzarVistes() {
        ...
        VistaMenu menu = new VistaMenu(ctrl);
        afegirVista("MENU", menu);

        // PANTALLA 1
        
        VistaGestionar gestionar = new VistaGestionar(ctrl);
        afegirVista("GESTIONAR", gestionar);

        VistaCrearEnquesta crear = new VistaCrearEnquesta(ctrl);
        afegirVista("CREAR", crear);

        // PANTALLA 2
        VistaCrearPregunta crearPregunta = new VistaCrearPregunta(ctrl);
