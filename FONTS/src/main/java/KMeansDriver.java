...
public class KMeansDriver {
    public static void main(String[] args) throws IOException {
        ...
        //Read chosen file number safely
        if (!sc.hasNextInt()) {
        ...
        int k;
        if (fname.contains("loan")) {
            k = 2;
            System.out.println("The value of k has been precomputed to 2");
        }
        else {
            k = 3;
            System.out.println("The value of k has been precomputed to 3");
        }
        ...
        if (tempData == null || tempData.length == 0) {
            System.out.println("The selected file is empty or could not be read.");
            return;
        }
