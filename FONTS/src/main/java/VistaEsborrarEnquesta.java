...
public class VistaEsborrarEnquesta extends JPanel {

    private CtrlPresentacio ctrl;
    private JList<String> listEnquestes;
    private DefaultListModel<String> listModel;

    public VistaEsborrarEnquesta(CtrlPresentacio ctrl) {
        this.ctrl = ctrl;
        ...
        btnCancelar.addActionListener(e -> this.ctrl.anarAGestionarEnquesta());
        ...
        btnEliminar.addActionListener(e -> {
            ...
            if (resp == JOptionPane.YES_OPTION) {
                String titol = extractTitol(seleccionada);
                this.ctrl.tractarEliminarEnquesta(titol);
            }
        });
    }
