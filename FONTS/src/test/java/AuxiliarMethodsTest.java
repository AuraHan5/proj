/* JUnit: AuxiliarMethodsTest — validates utility calculations (mode, stats, similarities) */
...
public class AuxiliarMethodsTest {
    ...
    /**
     * Comprova que calculateMaxVector funciona amb valors negatius.
     */
    @Test
    public void testCalculateMaxVectorNegative() {
        Object[][] data = {{-5.0},{-10.0},{-1.0}};
        int[] variableType = {0};
    ...
    /**
     * Comprova que calculateMinVector funciona amb un sol valor.
     */
    @Test
    public void testCalculateMinVectorSingleValue() {
        Object[][] data = {{42.0}};
        int[] variableType = {0};
        double[] min = AuxiliarMethods.calculateMinVector(data, variableType);
        assertArrayEquals(new double[]{42.0}, min);
    }

    /**
     * Comprova que calculateMode funciona amb un sol element.
     */
    @Test
    public void testCalculateModeSingleElement() {
        List<String> elements = List.of("single");
        String mode = AuxiliarMethods.calculateMode(elements);
        assertEquals("single", mode);
    }

    /**
     * Comprova que calculateAverage funciona amb valors molt grans.
     */
    @Test
    public void testCalculateAverageLargeValues() {
        List<Double> elements = List.of(1e10, 2e10, 3e10);
        Double average = AuxiliarMethods.calculateAverage(elements);
        assertEquals(2e10, average, 1e9);
    }
