/* JUnit: KMeansTest — checks KMeans construction and clustering on synthetic datasets */
...
public class KMeansTest {
    ...
    /**
     * Comprova que assignToCluster funciona amb k > nombre de punts.
     */
    @Test
    public void testAssignToClusterKGreaterThanPoints() {
        KMeans kmeans = new KMeans(5, 100);
    ...
    /**
     * Comprova que assignToCluster funciona amb tots els punts idèntics.
     */
    @Test
    public void testAssignToClusterIdenticalPoints() {
        KMeans kmeans = new KMeans(3, 100);
        ...
        assertEquals(4, clusters.length);
        for (int cluster : clusters) {
            assertTrue(cluster >= 0 && cluster < 3);
        }
    }

    /**
     * Comprova que el constructor accepta maxIterations = 0.
     */
    @Test
    public void testConstructorZeroIterations() {
        KMeans kmeans = new KMeans(2, 0);
        assertEquals(2, kmeans.getK());
    }

    /**
     * Comprova que assignToCluster funciona amb un sol punt.
     */
    @Test
    public void testAssignToClusterSinglePoint() {
        KMeans kmeans = new KMeans(2, 100);
        ...
        assertTrue(clusters[0] >= 0 && clusters[0] < 2);
    }
